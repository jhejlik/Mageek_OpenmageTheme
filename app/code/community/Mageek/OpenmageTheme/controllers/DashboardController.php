...
require_once(Mage::getModuleDir('controllers','Mage_Adminhtml').DS.'DashboardController.php');

//class Mage_Adminhtml_DashboardController extends Mage_Adminhtml_Controller_Action
class Mageek_OpenmageTheme_DashboardController extends Mage_Adminhtml_DashboardController
{
    ...
    public function tunnelAction()
    {
        ...
        if ($gaData && $gaHash) {
            ...
            if (hash_equals($newHash, $gaHash)) {
                ...
                if ($params) {
                    $response = $httpClient->setUri(Mageek_OpenmageTheme_Block_Adminhtml_Dashboard_Graph::API_URL)
